...
void LTexture::render(SDL_Renderer *gRenderer, int x, int y, int w, int h, SDL_Rect* clip) {
    //Set rendering space and render to screen
    SDL_Rect renderQuad = { x, y, w, h };
    SDL_RenderCopy( gRenderer, mTexture, clip, &renderQuad );
}

void LTexture::renderSpin( SDL_Renderer *gRenderer, int x, int y, SDL_Rect* clip, double angle, SDL_Point* center, SDL_RendererFlip flip )
{
    //Set rendering space and render to screen
    SDL_Rect renderQuad = { x, y, mWidth, mHeight };
